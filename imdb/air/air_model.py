...
class LSTMEncoder(nn.Module):
    ...
    def __init__(self, vocab_size, embed_size, hidden_size, z_dim, pad_idx, sigma):
...
class RNNVAE(nn.Module):
    ...
    def __init__(self, vocab_size, embed_size, time_step, hidden_size, z_dim,
                 dropout_rate, bos_idx, eos_idx, pad_idx, sigma):
        ...
        self.encoder = LSTMEncoder(vocab_size, embed_size,
                                   hidden_size, z_dim, pad_idx, sigma)
        
        #classify
       # self.class_1 = nn.Linear(z_dim, 16)
       # self.class_2 = nn.Linear(16, 8)
        self.class_3 = nn.Linear(z_dim, 2)
    ...
    def forward(self, enc_input, dec_input, length, labels):
        ...
        # classify
       # class_1 = F.relu(self.class_1(z))
       # class_2 = F.relu(self.class_2(class_1))
        logit_class = self.class_3(z)
        logc = F.log_softmax(logit_class, dim=-1)
        ...
        return logp, z, mu, logvar, logc, labels
